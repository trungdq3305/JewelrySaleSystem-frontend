...
const ManagerHomePage = () => {
  ...
  const handleAddProduct = async (formData) => {
    const requiredFields = ['productName', 'category', 'material', 'weight', 'machiningCost', 'size', 'amount', 'desc', 'image']
    ...
    <>
      <Box sx={{ display: 'flex', flexDirection: 'row', height: '100vh' }}>
        ...
        <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', padding: '20px' }}>
          <Paper sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', maxHeight: '80vh', overflow: 'hidden', padding: '10px' }}>
            <Button sx={{ alignSelf: 'flex-start', marginBottom: '10px' }} onClick={handleOpenDialog}>
              Add Product
            </Button>
            <TextField
              id="filled-search"
